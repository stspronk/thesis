...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-1.00000000000000005551e-01) <= v <= 1.69999999999999995559e+00);
    ocp1.subjectTo((-1.10000000000000008882e+00) <= u <= 1.10000000000000008882e+00);
    ocp1.subjectTo(5.00000000000000000000e+00 <= T <= 1.50000000000000000000e+01);
