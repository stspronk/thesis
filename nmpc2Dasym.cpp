...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "nmpc2Dasym_data_acadodata_M1.txt" );
    ...
    acadodata_f1 << dot(y) == (cos(phi)*cos(psi)+sin(phi)*sin(psi))*v_y;
    acadodata_f1 << dot(v_y) == 5.00000000000000000000e-01/5.00000000000000000000e-01*9.80000000000000071054e+00*sin(phi);
    acadodata_f1 << dot(phi) == (cos(phi)*r+p+sin(phi));
    acadodata_f1 << dot(psi) == cos(phi)*r;
    acadodata_f1 << dot(p) == ((-pow(omega2,2.00000000000000000000e+00)+pow(omega4,2.00000000000000000000e+00))*1.74999999999999988898e-01*6.10999999999999978704e-08+2.32000000000000001360e-03*r-4.00000000000000008327e-03*r)*4.31034482758620697496e+02;
    acadodata_f1 << dot(r) == ((-1.50000000000000019682e-09)*pow(omega1,2.00000000000000000000e+00)+1.50000000000000019682e-09*pow(omega2,2.00000000000000000000e+00)-1.50000000000000019682e-09*pow(omega3,2.00000000000000000000e+00)+1.50000000000000019682e-09*pow(omega4,2.00000000000000000000e+00)-2.32000000000000001360e-03*p+2.32000000000000001360e-03*p)*2.50000000000000000000e+02;

    OCP ocp1(0, 5, 50);
    ocp1.minimizeLSQ(acadodata_f2, acadodata_v2);
    ocp1.subjectTo(acadodata_f1);
    ocp1.subjectTo((-1.00000000000000000000e+01) <= v_y <= 1.00000000000000000000e+01);
