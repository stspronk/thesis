...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    acadodata_M1.read( "nmpc2Dsym_data_acadodata_M1.txt" );
    ...
    acadodata_f1 << dot(q) == (pow(omega1,2.00000000000000000000e+00)-pow(omega3,2.00000000000000000000e+00))*1.74999999999999988898e-01*4.31034482758620697496e+02*6.10999999999999978704e-08;
    acadodata_f1 << dot(theta) == q;
    acadodata_f1 << dot(x) == (cos(theta)*v_x+sin(theta)*v_z);
    acadodata_f1 << dot(z) == ((-sin(theta))*v_x+cos(theta)*v_z);
    acadodata_f1 << dot(v_x) == ((-sin(theta))*5.00000000000000000000e-01/5.00000000000000000000e-01*9.80000000000000071054e+00-q*v_z);
    acadodata_f1 << dot(v_z) == (((-6.10999999999999978704e-08)*(pow(omega1,2.00000000000000000000e+00)+pow(omega2,2.00000000000000000000e+00)+pow(omega3,2.00000000000000000000e+00)+pow(omega4,2.00000000000000000000e+00))+5.00000000000000000000e-01*9.80000000000000071054e+00*cos(theta))/5.00000000000000000000e-01-(-q)*v_x);

    OCP ocp1(0, 3, 30);
    ocp1.minimizeLSQ(acadodata_f2, acadodata_v2);
    ocp1.subjectTo(acadodata_f1);
    ocp1.subjectTo(z <= 0.00000000000000000000e+00);
    ocp1.subjectTo((-1.00000000000000000000e+01) <= v_z <= 1.00000000000000000000e+01);
    ocp1.subjectTo((-1.00000000000000000000e+01) <= v_x <= 1.00000000000000000000e+01);
    ...
    SimulationEnvironment algo2(0, 7, process2, controller3);
